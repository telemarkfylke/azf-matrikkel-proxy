...
const brregByOrgNr = async (orgNr) => {
  ...
  logger.info('Trying to call brreg using the main api url for OrgNr: {OrgNr}', orgNr)
  ...
  logger.info('Trying to call brreg using the sub api url for OrgNr: {OrgNr}', orgNr)
